...
public class SplitBinaryImage {
     ...
     */
    public static void splitBinaryFile(String inputPath, String outputPath1, String outputPath2) throws IOException {
        ...
        System.arraycopy(fileData, mid, part2, 0, fileData.length - mid);
        ...
        System.out.println("📄 Part 1: " + outputPath1 + " (" + part1.length + " bytes)");
        System.out.println("📄 Part 2: " + outputPath2 + " (" + part2.length + " bytes)");
    }
}
